 ...
 * @author  Philip White
 */
public class SelectManyMenuImmediateTester extends SelectTester {

	@Test
	public void runSelectManyMenuImmediateTest() throws Exception {
		Browser browser = Browser.getInstance();
		browser.get(TEST_CONTEXT_URL + "/selectmanymenu/immediate");
		...
		// Test that the first value in the second menu submits successfully.
		...
		// Test that only the third value in the second menu submits successfully.
