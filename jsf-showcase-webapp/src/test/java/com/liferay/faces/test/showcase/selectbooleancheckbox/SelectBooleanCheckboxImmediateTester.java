...
public class SelectBooleanCheckboxImmediateTester extends SelectTester {
	...
	public void runSelectBooleanCheckboxImmediateTest() throws Exception {
		...
		// Test that the web page shows an error message when a value is
		// required and an empty value is submitted.
		String text = "false";
		...
		SeleniumAssert.assertElementTextVisible(browser, "(//div[@class='results-content'])[2]", text);
