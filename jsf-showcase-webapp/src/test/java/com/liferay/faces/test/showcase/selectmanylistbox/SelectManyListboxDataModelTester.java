 ...
 * @author  Philip White
 */
public class SelectManyListboxDataModelTester extends SelectTester {

	@Test
	public void runSelectManyListboxDataModelTest() throws Exception {
		Browser browser = Browser.getInstance();
		browser.get(TEST_CONTEXT_URL + "/selectmanylistbox/data-model");

		// Wait to begin the test until the model value button is rendered.
