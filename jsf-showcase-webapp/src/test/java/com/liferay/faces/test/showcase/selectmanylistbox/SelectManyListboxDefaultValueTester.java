 ...
 * @author  Philip White
 */
public class SelectManyListboxDefaultValueTester extends SelectTester {

	@Test
	public void runSelectManyListboxDefaultValueTest() throws Exception {
		Browser browser = Browser.getInstance();
		browser.get(TEST_CONTEXT_URL + "/selectmanylistbox/default-value");

		// Wait to begin the test until the model value is rendered.
