 ...
 * @author  Philip White
 */
public class SelectManyListboxConversionTester extends SelectTester {

	@Test
	public void runSelectManyListboxConversionTest() throws Exception {
		Browser browser = Browser.getInstance();
		browser.get(TEST_CONTEXT_URL + "/selectmanylistbox/conversion");
		...
		// Test that the incorrect checked values submit successfully.
		...
		// Test that the correct checked values submit successfully.
