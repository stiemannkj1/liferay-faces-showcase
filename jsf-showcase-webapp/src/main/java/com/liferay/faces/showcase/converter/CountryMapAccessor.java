 ...
 */
/* package-private */ class CountryMapAccessor extends ThreadSafeAccessor<Map<Long, Country>, FacesContext> {

	// Package-Private Constants
	/* package-private */ static final CountryMapAccessor INSTANCE = new CountryMapAccessor();

	@Override
	protected Map<Long, Country> computeValue(FacesContext facesContext) {
