...
public class ShowcaseModelBean implements Serializable {
	...
	public static boolean isBootstrap2(FacesContext facesContext) {
		...
		final ProductInfo ALLOY = productInfoFactory.getProductInfo(ProductInfo.Name.LIFERAY_FACES_ALLOY);
	...
	public String getDeploymentType() {
		...
		if (deploymentType == null) {
			...
			final ProductInfo LIFERAY_FACES_BRIDGE = ProductInfoFactory.getProductInfoInstance(externalContext,
